...
const LogIn = () => {
  ...
  return (
    <div className="log-in">
      <Helmet id="Digital Destinations Login">
        <title>Join the community</title>
        <meta name="description" content="Digital Destinations Login" />
        <meta property="og:title" content="Digital Destinations Login" />
      </Helmet>
      <img src={logo} alt="Digital Destinations" />
